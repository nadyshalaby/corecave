...
abstract class Model {
    ...
    public function edit() {
        ...
        $obj = new $cls;
        static::update($this->columns, "{$obj->primary_key} = ?", [$this->columns[$id]]);
    }
    ...
    public function remove() {
        ...
        $obj = new $cls;
        $id = $obj->primary_key;
        static::delete("{$id} = ?", [$this->columns[$id]]);
    }
    ...
    public static function all($limit = 0) {
        return static::where(null, null, $limit);
    }
    ...
    public static function id($value) {
        ...
        $obj = new $cls;
        $id = $obj->primary_key;
        return static::where("{$id} = ?", [$value])[0];
    }
    ...
    public static function where($condition = '', $placeholderVals = [], $limit = 0) {
        return static::select(false, null, $condition, $placeholderVals, null, null, null, $limit);
    }
     ...
     * @return array|null
     */
    public static function having($groubBy = [], $condition = '', $placeholderVals = [], $limit = 0) {

        return static::select(false, null, null, $placeholderVals, (count($groubBy)) ? implode(",", $groubBy) : null, $condition, null, $limit);
    }
    ...
    public static function orderBy($columns = '', $limit = 0) {
        return static::select(false, null, null, null, null, null, $columns, $limit);
    }
    ...
    public static function groubBy($columns = [], $limit = 0) {
        return static::select(false, null, null, null, implode(",", $columns), null, null, $limit);
    }
    ...
    public static function findBy(array $columns) {
        ...
        if (!empty(static::where($condition, array_values($columns)))) {
            return true;
        }
        return false;
    }
    ...
    public static function with(array $columns, $limit = 0) {
        $cols = array_keys($columns);
        $condition = implode(' = ? AND ', $cols) . ' = ?';
        return static::where($condition, array_values($columns), $limit);
    }
    ...
    public static function insert(array $columns = []) {
        ...
        static::$lastId[$cls] = DB::getInstance()->lastId();
    ...
    public static function first($condition = '', $placeholderVals = []) {
        $data = static::where($condition, $placeholderVals, 1);
        if (empty($data)) {
            return null;
        }
        return $data[0];
    ...
    public static function last($condition = '', $placeholderVals = []) {
        ...
        $data = static::where($condition, $placeholderVals);
        if (empty($data)) {
            return null;
        }
    ...
    public static function updateOrInsert($columns = [], $condition = '', $placeholderVals = []) {
        if (!static::update($columns, $condition, $placeholderVals)) {
            return static::insert($columns);
        }
        return true;
    }
    ...
    public static function lastId() {
        $cls = get_called_class();
        if (isset(static::$lastId[$cls])) {
            return static::$lastId[$cls];
        }
        return null;
    }
